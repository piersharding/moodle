...
M.mod_scormform.init = function(Y) {
    ...
    scormform.setAttribute('onsubmit', "window.open('','Popup','"+poptions+"'); this.target='Popup'; parent.window.location = '"+M.cfg.wwwroot+"/course/view.php?id="+courseid+"&sesskey="+M.cfg.sesskey+"';");
}
